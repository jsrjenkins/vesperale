...
\newcommand{\tempus}{pentecostes}%{quadragesima}%{pentecostes}%{adventus}%% what season or proper
\newcommand{\numerus}{viii}%{xiii}%% CHANGE THIS TO WHICH SUNDAY AFTER PENTECOST
...
\usepackage[top=15mm, bottom=10mm, outer=15mm, inner=15mm]{geometry}% Margins
