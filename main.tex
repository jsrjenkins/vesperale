...
\newcommand{\tempus}{pentecostes}%{adventus}%% what season or proper
\newcommand{\numerus}{xiii}%% CHANGE THIS TO WHICH SUNDAY AFTER PENTECOST
\newcommand{\lang}{polish}%{english} %which language translation. %
