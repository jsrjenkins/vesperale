\item Sit nomen Dómini \textbf{be}ne\textbf{dí}ctum,~* ex hoc nunc, et us\textit{que} \textit{in} \textbf{sǽ}culum.
...
\item Súscitans a \textbf{ter}ra \textbf{í}nopem,~* et de stércore é\textit{ri}\textit{gens} \textbf{páu}perem:
