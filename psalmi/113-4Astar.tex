\item Facta est Judǽa sanctificá\textit{ti}\textit{o} \textbf{e}jus,~* Israël \textit{po}\textit{té}\textit{stas} \textbf{e}jus.

\item Mare vi\textit{dit}, \textit{et} \textbf{fu}git:~* Jordánis convér\textit{sus} \textit{est} \textit{re}\textbf{trór}sum.

\item Montes exsultavérunt \textit{ut} \textit{a}\textbf{rí}etes,~* et colles si\textit{cut} \textit{a}\textit{gni} \textbf{ó}vium.
...
\item Montes, exsultástis si\textit{cut} \textit{a}\textbf{rí}etes,~* et colles, si\textit{cut} \textit{a}\textit{gni} \textbf{ó}vium.
...
\item Deus autem no\textit{ster} \textit{in} \textbf{cæ}lo:~* ómnia quæcúmque \textit{vó}\textit{lu}\textit{it}, \textbf{fe}cit.
...
\item Domus Israël sperá\textit{vit} \textit{in} \textbf{Dó}mino:~* adjútor eórum et pro\textit{té}\textit{ctor} \textit{e}\textbf{ó}rum est,

\item Domus Aaron sperá\textit{vit} \textit{in} \textbf{Dó}mino:~* adjútor eórum et pro\textit{té}\textit{ctor} \textit{e}\textbf{ó}rum est,

\item Qui timent Dóminum, speravé\textit{runt} \textit{in} \textbf{Dó}mino:~* adjútor eórum et pro\textit{té}\textit{ctor} \textit{e}\textbf{ó}rum est.

\item Dóminus memor \textit{fu}\textit{it} \textbf{no}stri:~* et be\textit{ne}\textit{dí}\textit{xit} \textbf{no}bis:
...
\item Adjíciat Dó\textit{mi}\textit{nus} \textbf{su}per vos:~* super vos, et super \textit{fí}\textit{li}\textit{os} \textbf{ve}stros.
